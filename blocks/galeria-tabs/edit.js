        ...
        <>
            <InspectorControls>
                ...
                <PanelColorSettings
                    ...
                    colorSettings={[
                        ...
                        },
                        {
                            ...
                            label: __('Color del overlay', 'diadelasempresasdelbosque')
                        },
                        {
                            value: captionTextColor,
                            onChange: (color) => setAttributes({ captionTextColor: color }),
                            label: __('Color del texto del caption', 'diadelasempresasdelbosque')
                        }
                    ]}
                />
                ...
                <PanelBody title={__('Diseño', 'diadelasempresasdelbosque')} initialOpen={false}>
                    ...
                    <RangeControl
                        label={__('Columnas en desktop', 'diadelasempresasdelbosque')}
                        value={columnasDesktop}
                        onChange={(value) => setAttributes({ columnasDesktop: value })}
                        min={2}
                        max={4}
                        help={__('Cantidad de imágenes por fila', 'diadelasempresasdelbosque')}
                    />
                </PanelBody>
                ...
                <PanelBody title={__('Configuración "Ver Más"', 'diadelasempresasdelbosque')} initialOpen={false}>
                    <ToggleControl
                        ...
                        help={__('Muestra imágenes de forma progresiva', 'diadelasempresasdelbosque')}
                    />

                    {usarVerMas && (
                        <>
                            <RangeControl
                                label={__('Imágenes iniciales', 'diadelasempresasdelbosque')}
                                value={imagenesIniciales}
                                onChange={(value) => setAttributes({ imagenesIniciales: value })}
                                min={3}
                                max={20}
                                help={__('Cantidad de imágenes a mostrar inicialmente', 'diadelasempresasdelbosque')}
                            />

                            <RangeControl
                                label={__('Imágenes por carga', 'diadelasempresasdelbosque')}
                                value={imagenesPorCarga}
                                onChange={(value) => setAttributes({ imagenesPorCarga: value })}
                                min={3}
                                max={20}
                                help={__('Cantidad de imágenes adicionales al hacer clic en "Ver más"', 'diadelasempresasdelbosque')}
                            />
                ...
                {/* Años y Galerías */}
                <PanelBody title={__('Años y Galerías', 'diadelasempresasdelbosque')} initialOpen={true}>
                    <Button 
                        variant="primary" 
                        onClick={addYear}
                        className="mb-3"
                    >
                        {__('Agregar Año', 'diadelasempresasdelbosque')}
                    </Button>
